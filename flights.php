            ...
            <div class="container h-100">
                <div class="row h-100 align-items-center justify-content-center text-center">
                    <div class="col-lg-10 align-self-end mb-4 page-title">
                    	<h3 class="text-white">الرحلات الجويه</h3>
                        <hr class="divider my-4" />
                        <div class="col-md-12 mb-2 text-left">
                        <div class="card">
                            <div class="card-body">
                                <form id="manage-filter"  action="userinfo.php?id=<?php echo $id ?>" method="POST">
                                    <div class="row form-group">
                                    
                                        <div class="col-sm-3">
                                            <label for="" class="control-label">الوجهه</label>
                                            <select name="desination_city" id="desination_city" class="custom-select browser-default select2">
                                            ...
                                            ?>
                                                <option value="<?php echo $row['airport'] ?>" <?php echo isset($desination_city) && $desination_city == $row['id'] ? "selected" : '' ?>><?php echo $row['location'].", ".$row['airport'] ?></option>
                                            <?php endwhile; ?>
                                            </select>
                                        </div>
                                        <div class="col-sm-3">
                                            <label for="" class="control-label">تاريخ المغادره</label>
                                            <input type="date" class="form-control input-sm datetimepicker2" name="departure_time" autocomplete="off" value="<?php echo isset($date) && !empty($date) ? date("Y-m-d",strtotime($date)) : "" ?>">
                                        </div>
                                        <div class="col-sm-3" id="rdate" <?php if(isset($trip) && $trip == 1): ?> style="display: none" <?php endif; ?>>
                                            <label for="" class="control-label">تاريخ الرجوع</label>
                                            <input type="date" class="form-control input-sm datetimepicker2" name="return_time" autocomplete="off" value="<?php echo isset($date_return) && !empty($date_return) ? date("Y-m-d",strtotime($date_return)) : "" ?>">
                                        </div>

										<div class="col-sm-3">
                                            <label for="" class="control-label">الأسم</label>
                                            <input type="text" class="form-control input-sm datetimepicker2" name="name" autocomplete="off" value="">
                                        </div>
                                        <div class="col-sm-3" id="rdate" <?php if(isset($trip) && $trip == 1): ?> style="display: none" <?php endif; ?>>
                                            <label for="" class="control-label">رقم الهاتف</label>
                                            <input type="number" class="form-control input-sm datetimepicker2" name="phone" autocomplete="off" value="">
                                        </div>
                                        <div class="col-sm-3">
                                            <label for="" class="control-label">الوزن</label>
                                            <input type="text" class="form-control input-sm datetimepicker2" name="weight" autocomplete="off" value="">
                                        </div>
                                    ...
                                    <div class="row form-group">
                                        ...
                                        <div class="col-sm-3 offset-sm-5">
                                            <!-- <button class="btn btn-block btn-sm btn-primary"><i class="fa fa-plane-departure"></i>البحث عن الرحلات الجويه</button> -->
											<button class="btn btn-block btn-sm btn-primary">أحجز الأن</button>
										</div>
                                    </div>
                                </form>
                            </div>
