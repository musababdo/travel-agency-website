            ...
            <div class="container h-100">
                <div class="row h-100 align-items-center justify-content-center text-center">
                    <div class="col-lg-10 align-self-end mb-4 page-title">
                    	<h3 class="text-white">الشحن</h3>
                        <hr class="divider my-4" />
                        <div class="col-md-12 mb-2 text-left">
                        <div class="card">
                            <div class="card-body">
                                <form id="manage-filter"  action="chargeinfo.php?id=<?php echo $id ?>" method="POST">
                                    <div class="row form-group">
                                    <div class="col-sm-3">
                                            <label for="" class="control-label">عدد الطرد</label>
                                            <input type="number" class="form-control input-sm datetimepicker2" name="number" autocomplete="off" value="">
                                        </div>
                                        <div class="col-sm-3">
                                            <label for="" class="control-label">الوزن</label>
                                            <input type="number" class="form-control input-sm datetimepicker2" name="weight" autocomplete="off" value="">
                                        </div>
                                        <div class="col-sm-3">
                                            <label for="" class="control-label">المحتويات</label>
                                            <textarea class="form-control input-sm datetimepicker2" name="things" autocomplete="off" value=""></textarea>
                                        </div>
                                        <div class="col-sm-3">
                                            <label for="" class="control-label">مكان الشحن</label>
                                            <input type="text" class="form-control input-sm datetimepicker2" name="place" autocomplete="off" value="">
                                        </div>
                                        <div class="col-sm-3">
                                            <label for="" class="control-label">نوع الشحن</label>
                                            <select name="type" class="form-control">
                                                <option value="">أختر نوع الشحن</option>
                                                <option value="أمتعه شخصيه">أمتعه شخصيه</option>
                                                <option value="عربات">عربات</option>
                                            </select>
                                        </div>
                                    ...
                                    <div class="row form-group">
                                        <div class="col-sm-3 offset-sm-5">
											...
											<button class="btn btn-block btn-sm btn-primary">أشحن الأن</button>
										</div>
                                    </div>
                                </form>
                            </div>
