			...
			<div class="row">
				<div class="col-md-8">
					<div class="form-group">
						<label for="" class="control-label">شركه الطيران</label>
	 ...
	 $('#manage-flight').submit(function(e){
	 	...
	 	$.ajax({
	 		...
	 		success:function(resp){
	 			if(resp == 1){
	 				alert_toast("تم حفظ الرحله بنجاح","success");
