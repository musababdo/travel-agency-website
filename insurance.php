            ...
            <div class="container h-100">
                <div class="row h-100 align-items-center justify-content-center text-center">
                    <div class="col-lg-10 align-self-end mb-4 page-title">
                    	<h3 class="text-white">التأمين (شركه السلامه للتأمين)</h3>
                        <hr class="divider my-4" />
                        <div class="col-md-12 mb-2 text-left">
                        <div class="card">
                            <div class="card-body">
                                <form id="manage-filter"  action="insuranceinfo.php?id=<?php echo $id ?>" method="POST">
                                    <div class="row form-group">
                                    <div class="col-sm-3">
                                            <label for="" class="control-label">نوع التأمين</label>
                                            <select name="type" class="form-control">
                                                <option value="">أختر نوع التأمين</option>
                                                <option value="تأمين طريق">تأمين طريق</option>
                                                <option value="تأمين حريق">تأمين حريق</option>
                                                <option value="تأمين شامل للسيارات">تأمين شامل للسيارات</option>
                                            </select>
                                        </div>
                                        <div class="col-sm-3">
                                            <label for="" class="control-label">أسم المؤمن عليه</label>
                                            <input type="text" class="form-control input-sm datetimepicker2" name="comname" autocomplete="off" value="وكاله الأسكله للسفر والسياحه">
                                        </div>
                                        <div class="col-sm-3">
                                            <label for="" class="control-label">العنوان</label>
                                            <input type="text" class="form-control input-sm datetimepicker2" name="address" autocomplete="off" value="">
                                        </div>
                                    ...
                                    <div class="col-sm-3">
                                        ...
                                        <div class="col-sm-3 offset-sm-5">
											...
											<button class="btn btn-block btn-sm btn-primary">حفظ</button>
										</div>
                                    </div>
                                </form>
                            </div>
