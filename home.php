                            ...
                            <div class="card-body">
                                <form id="manage-filter" action="index.php?page=flights" method="POST">
                                    <div class="row form-group">
                                        <div class="col-sm-3">
                                            <label for="" class="control-label">من</label>
                                        ...
                                        <div class="col-sm-3">
                                            <label for="" class="control-label">الي</label>
                                    ...
                                    <div class="row form-group">
                                        ...
                                        <div class="col-sm-3 offset-sm-5">
                                            <button class="btn btn-block btn-sm btn-primary" type="submit"><i class="fa fa-plane-departure"></i>البحث عن الرحلات الجويه</button>
                                        </div>
                                    </div>
                                </form>
                            </div>
